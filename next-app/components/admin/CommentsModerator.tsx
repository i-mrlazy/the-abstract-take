...
import { CheckCircle2, EyeOff, Trash2, Search } from 'lucide-react';

interface CommentsModeratorProps {
  initialComments: Comment[];
}

export function CommentsModerator({ initialComments }: CommentsModeratorProps) {
            ...
            >
              <div className="space-y-1.5 max-w-3xl">
                ...
                <p className="text-[10px] font-mono text-gray-400">
                  Review: {c.reviewTitle || c.reviewId}
                </p>
              </div>
