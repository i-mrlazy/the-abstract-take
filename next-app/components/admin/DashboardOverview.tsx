...
import { getQualityLabel, getRatingColorClasses, normalizeScore } from '@/lib/utils/rating';
    ...
    <div className="space-y-6 text-gray-900">
      ...
      <div className="bg-white border border-gray-200/90 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5 shrink-0">
          <Link
            ...
            className="px-4 py-2.5 bg-[#008CFF] hover:bg-[#0077dd] text-white font-sans font-bold text-xs uppercase tracking-wider rounded-xl shadow-xs flex items-center space-x-2 transition-all"
          >
          ...
          <Link
            href="/"
            target="_blank"
            className="px-3.5 py-2.5 bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-xl border border-gray-200 text-xs font-mono flex items-center space-x-1.5 shadow-2xs transition-colors"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link
          ...
          className="bg-white border border-gray-200/90 rounded-2xl p-5 shadow-sm flex flex-col justify-between hover:border-[#008CFF] transition-all group"
        >
          <div className="flex items-center justify-between text-gray-500">
            <span className="text-xs font-mono uppercase font-semibold">Published Takes</span>
            <div className="p-2 bg-blue-50 text-[#008CFF] rounded-xl group-hover:bg-[#008CFF] group-hover:text-white transition-colors">
          ...
          <div className="mt-3">
            ...
            <span className="text-[11px] font-mono text-gray-500 block mt-0.5">
              Live on publication ({reviews.length} total)
            </span>
          </div>
        </Link>
        ...
        <Link
          ...
          className="bg-white border border-gray-200/90 rounded-2xl p-5 shadow-sm flex flex-col justify-between hover:border-amber-400 transition-all group"
        >
          <div className="flex items-center justify-between text-gray-500">
          ...
          <div className="mt-3">
            ...
            <span className="text-[11px] font-mono text-gray-500 block mt-0.5">
              {archivedCount > 0 ? `${archivedCount} archived` : 'Private in editor'}
            </span>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center justify-between text-gray-500">
            <span className="text-xs font-mono uppercase font-semibold">Curated Lists</span>
            <div className="p-2 bg-blue-50 text-[#008CFF] rounded-xl group-hover:bg-[#008CFF] group-hover:text-white transition-colors">
        ...
        <Link
          ...
          className="bg-white border border-gray-200/90 rounded-2xl p-5 shadow-sm flex flex-col justify-between hover:border-emerald-500 transition-all group"
        >
          <div className="flex items-center justify-between text-gray-500">
          ...
          <div className="mt-3">
            ...
            <span className="text-[11px] font-mono text-emerald-700 font-semibold flex items-center space-x-1 mt-0.5">
              ...
              <span>Abstract Dispatch active</span>
            </span>
          </div>
        </Link>
      </div>

      {/* Format Breakdown & Pending Moderation */}
              ...
              {pendingComments.slice(0, 3).map((c) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="px-3 py-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200 rounded-lg text-xs font-mono font-bold flex items-center space-x-1 shrink-0 transition-colors cursor-pointer"
                  >
      ...
      <div className="bg-white border border-gray-200/90 rounded-2xl p-6 shadow-sm space-y-4">
        ...
        <div className="divide-y divide-gray-100">
          {recentReviews.map((review) => {
            ...
            const scoreLabel = getQualityLabel(normScore);
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center space-x-3 shrink-0">
                  <span className={`px-2.5 py-1 ${colors.badgeBg} ${colors.badgeText} border ${colors.border} font-mono font-bold text-xs rounded-lg`}>
                    {normScore}/10 · {scoreLabel.toUpperCase()}
                  </span>
                  <span
