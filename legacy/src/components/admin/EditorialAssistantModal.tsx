...
import { EditorialDraftResult, MediaType, WatchVerdict } from '../../types';
...
export function EditorialAssistantModal({
  ...
  const handleGenerate = async (e: React.FormEvent) => {
    ...
    try {
      const draft = await api.generateEditorialDraft({
        title: title.trim(),
        year,
        contentType,
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {!result ? (
            ...
            <form onSubmit={handleGenerate} className="space-y-5">
              ...
              {/* Optional Facts & Context (Collapsible or Clean Fields) */}
